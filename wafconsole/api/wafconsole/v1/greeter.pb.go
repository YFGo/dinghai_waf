...
// 	protoc        v3.19.3
// source: wafconsole/v1/greeter.proto
...
var file_helloworld_v1_greeter_proto_goTypes = []interface{}{
	(*HelloRequest)(nil), // 0: wafconsole.v1.HelloRequest
	(*HelloReply)(nil),   // 1: wafconsole.v1.HelloReply
}
var file_helloworld_v1_greeter_proto_depIdxs = []int32{
	0, // 0: wafconsole.v1.Greeter.SayHello:input_type -> wafconsole.v1.HelloRequest
	1, // 1: wafconsole.v1.Greeter.SayHello:output_type -> wafconsole.v1.HelloReply

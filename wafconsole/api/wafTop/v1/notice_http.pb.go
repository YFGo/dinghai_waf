...
const OperationNoticeCreateNotice = "/api.wafTop.v1.Notice/CreateNotice"
const OperationNoticeDeleteNotice = "/api.wafTop.v1.Notice/DeleteNotice"
const OperationNoticeGetNotice = "/api.wafTop.v1.Notice/GetNotice"
const OperationNoticeListNotice = "/api.wafTop.v1.Notice/ListNotice"
const OperationNoticeUpdateNotice = "/api.wafTop.v1.Notice/UpdateNotice"
...
func RegisterNoticeHTTPServer(s *http.Server, srv NoticeHTTPServer) {
	r := s.Route("/")
	r.POST("/app/waf_top/v1/notice", _Notice_CreateNotice0_HTTP_Handler(srv))
	r.PUT("/app/waf_top/v1/notice/state", _Notice_UpdateNotice0_HTTP_Handler(srv))
	r.DELETE("/app/waf_top/v1/notice", _Notice_DeleteNotice0_HTTP_Handler(srv))
	r.GET("/app/waf_top/v1/notice/{id}", _Notice_GetNotice0_HTTP_Handler(srv))
	r.GET("/app/waf_top/v1/notices", _Notice_ListNotice0_HTTP_Handler(srv))
}
...
func (c *NoticeHTTPClientImpl) GetNotice(ctx context.Context, in *GetNoticeRequest, opts ...http.CallOption) (*GetNoticeReply, error) {
	...
	pattern := "/app/waf_top/v1/notice/{id}"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *NoticeHTTPClientImpl) ListNotice(ctx context.Context, in *ListNoticeRequest, opts ...http.CallOption) (*ListNoticeReply, error) {
	...
	pattern := "/app/waf_top/v1/notices"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *NoticeHTTPClientImpl) UpdateNotice(ctx context.Context, in *UpdateNoticeRequest, opts ...http.CallOption) (*UpdateNoticeReply, error) {
	...
	pattern := "/app/waf_top/v1/notice/state"
	path := binding.EncodeURL(pattern, in, false)

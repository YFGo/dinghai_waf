...
const (
	Server_CreateServer_FullMethodName = "/api.wafTop.v1.Server/CreateServer"
	Server_UpdateServer_FullMethodName = "/api.wafTop.v1.Server/UpdateServer"
	Server_DeleteServer_FullMethodName = "/api.wafTop.v1.Server/DeleteServer"
	Server_GetServer_FullMethodName    = "/api.wafTop.v1.Server/GetServer"
	Server_ListServer_FullMethodName   = "/api.wafTop.v1.Server/ListServer"
)
...
func (c *serverClient) DeleteServer(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteReply)
...
func _Server_DeleteServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServerServer).DeleteServer(ctx, req.(*DeleteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Server_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.wafTop.v1.Server",
	...
	Metadata: "api/wafTop/v1/server.proto",
}

...
// 	protoc        v3.19.3
// source: wafTop/v1/greeter.proto
...
var file_helloworld_v1_greeter_proto_goTypes = []interface{}{
	(*HelloRequest)(nil), // 0: wafTop.v1.HelloRequest
	(*HelloReply)(nil),   // 1: wafTop.v1.HelloReply
}
var file_helloworld_v1_greeter_proto_depIdxs = []int32{
	0, // 0: wafTop.v1.Greeter.SayHello:input_type -> wafTop.v1.HelloRequest
	1, // 1: wafTop.v1.Greeter.SayHello:output_type -> wafTop.v1.HelloReply

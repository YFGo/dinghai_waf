...
type Kafka struct {
	...
	Topic         string                 `protobuf:"bytes,3,opt,name=topic,proto3" json:"topic,omitempty"`                    // 新增
	GroupId       string                 `protobuf:"bytes,4,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"` // 新增（消费者组）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_conf_conf_proto_rawDesc = string([]byte{
	...
	0x74, 0x22, 0xb8, 0x03, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64, 0x61,

...
// 	protoc        v3.12.4
// source: wafconsole/app/dashBorad/internal/conf/conf_driver.proto
...
func (x *ConfDriver) Reset() {
	*x = ConfDriver{}
	mi := &file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_msgTypes[0]
...
func (*ConfDriver) Descriptor() ([]byte, []int) {
	return file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_rawDescGZIP(), []int{0}
}
...
func (x *ConfConsul) Reset() {
	*x = ConfConsul{}
	mi := &file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConfConsul) Descriptor() ([]byte, []int) {
	return file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_rawDescGZIP(), []int{1}
}
...
func (x *ConfEtcd) Reset() {
	*x = ConfEtcd{}
	mi := &file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConfEtcd) Descriptor() ([]byte, []int) {
	return file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_rawDescGZIP(), []int{2}
}
...
var File_wafconsole_app_dashBorad_internal_conf_conf_driver_proto protoreflect.FileDescriptor

var file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_rawDesc = string([]byte{
	0x0a, 0x38, 0x77, 0x61, 0x66, 0x63, 0x6f, 0x6e, 0x73, 0x6f, 0x6c, 0x65, 0x2f, 0x61, 0x70, 0x70,
	...
	0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x42, 0x2d, 0x5a, 0x2b, 0x77, 0x61, 0x66, 0x63,
	0x6f, 0x6e, 0x73, 0x6f, 0x6c, 0x65, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x64, 0x61, 0x73, 0x68, 0x42,
	0x6f, 0x72, 0x61, 0x64, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63, 0x6f,
	0x6e, 0x66, 0x3b, 0x63, 0x6f, 0x6e, 0x66, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_rawDescOnce sync.Once
	file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_rawDescData []byte
)

func file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_rawDescGZIP() []byte {
	file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_rawDescOnce.Do(func() {
		file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_rawDesc), len(file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_rawDesc)))
	})
	return file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_rawDescData
}

var file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_goTypes = []any{
	(*ConfDriver)(nil), // 0: kratos.api.ConfDriver
	(*ConfConsul)(nil), // 1: kratos.api.ConfConsul
	(*ConfEtcd)(nil),   // 2: kratos.api.ConfEtcd
}
var file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_depIdxs = []int32{
...
func init() { file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_init() }
func file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_init() {
	if File_wafconsole_app_dashBorad_internal_conf_conf_driver_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_rawDesc), len(file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_goTypes,
		DependencyIndexes: file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_depIdxs,
		MessageInfos:      file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_msgTypes,
	}.Build()
	File_wafconsole_app_dashBorad_internal_conf_conf_driver_proto = out.File
	file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_goTypes = nil
	file_wafconsole_app_dashBorad_internal_conf_conf_driver_proto_depIdxs = nil
}
